...
function Data = ImportExpData(filename, startRow, endRow)
...
Data.ShoulderFlex = dataArray{:, 2};
Data.ShoulderRotation = dataArray{:, 3};
Data.ShoulderAbduction = dataArray{:, 4};
Data.ElbowFlex = dataArray{:, 5};
Data.WristFlex = dataArray{:, 6};
Data.Acro_x = dataArray{:, 7};
Data.Acro_y = dataArray{:, 8};
Data.Acro_z = dataArray{:, 9};
Data.Olec_x = dataArray{:, 10};
Data.Olec_y = dataArray{:, 11};
Data.Olec_z = dataArray{:, 12};
Data.Hand_x = dataArray{:, 13};
Data.Hand_y = dataArray{:, 14};
Data.Hand_z = dataArray{:, 15};
