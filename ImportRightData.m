...
function Data = ImportRightData(filename, startRow, endRow)
...
Data.RightShoulderFlex = dataArray{:, 2};
Data.RightShoulderRotation = dataArray{:, 3};
Data.RightShoulderAbduction = dataArray{:, 4};
Data.RightElbowFlex = dataArray{:, 5};
Data.RightWristFlex = dataArray{:, 6};
Data.R_acro_x = dataArray{:, 7};
Data.R_acro_y = dataArray{:, 8};
Data.R_acro_z = dataArray{:, 9};
Data.R_olec_x = dataArray{:, 10};
Data.R_olec_y = dataArray{:, 11};
Data.R_olec_z = dataArray{:, 12};
Data.R_hand_x = dataArray{:, 13};
Data.R_hand_y = dataArray{:, 14};
Data.R_hand_z = dataArray{:, 15};
